...
def get_model(streamType, numSeg):
    if streamType == 'rgb':
        # RGB input has 3 channels.  新版tf的placeholder替换为：tf.compat.v1.placeholder
        ...
        saver = tf.compat.v1.train.Saver(var_list=rgb_variable_map, reshape=True)
